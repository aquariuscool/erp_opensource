...
class LazadaInterface_Helper_V2{
	...
	function getAuthUrl($state='state',$redirect_uri=''){
		$params = array(
		        ...
		        'client_id' => \Yii::$app->params['apiInfo']['lazada']['appKey'], // 创建应用时获得的App Key
...
#####################################################################################
	...
	function getToken($code=''){
	    $config = [
	        'countryCode'=>'my',
	        'APP_KEY'=>\Yii::$app->params['apiInfo']['lazada']['appKey'],
	        'APP_SECRET'=>\Yii::$app->params['apiInfo']['lazada']['appSecret'],
	        'userId'=>'',
	        'apiKey'=>'',
...
#####################################################################################
	...
	{
	    $config['APP_KEY'] = \Yii::$app->params['apiInfo']['lazada']['appKey'];
	    $config['APP_SECRET'] = \Yii::$app->params['apiInfo']['lazada']['appSecret'];
	    $reqParams = array(
	        "config" => json_encode($config),
	        "action" => "/order/get",
	        "reqParams" => json_encode($reqParams)
	...
	private static function _callLazadaRestApi($getParameters=array(),$postParameters=false){
	    ...
	    $getParameters['appName'] = \Yii::$app->params['apiInfo']['lazada']['appName'];
