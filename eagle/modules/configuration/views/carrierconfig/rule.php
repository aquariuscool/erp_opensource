...
$this->registerJsFile($baseUrl."js/project/configuration/carrierconfig/rule/rule.js?v=".$tmp_js_version, ['depends' => [JuiAsset::class,'yii\bootstrap\BootstrapPluginAsset']]);
